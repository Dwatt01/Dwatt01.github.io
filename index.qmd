---
title: "Darius Watt" # change this to your name
image: images/linkedin_pic # change to your profile pic
about:
  template: jolla # templates: jolla, trestles, solana, marquee, broadside
  links: 
    - icon: envelope
      text: Contact Me
      href: mailto:dwatt01@hamline.edu # change to your email
    - icon: linkedin
      href: https://www.linkedin.com/in/dariuswatt/ # change to your linkedin address
    - icon: github
      href: https://github.com/dwatt01 # change to your github address
    - icon: twitter
